export class ChessAI {
    static getBestMove(board, color) {
        ...
        try {
            ...
            const ChessEngine = window['js-chess-engine'] || window.jsChessEngine;
            if (!ChessEngine) {
    ...
    static boardToEngineFormat(board, turn = 'white') {
        const config = {
            pieces: {},
    ...
    static pieceToEngineCode(piece) {
    ...
    static positionToAlgebraic(pos) {
    ...
    static algebraicToPosition(square) {
    ...
    static getFallbackMove(board, color) {
